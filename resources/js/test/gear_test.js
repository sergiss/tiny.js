...
const game = new Game(canvas, {
    ...
    update: () => {
        ...
        if (world.bodies.length > 30) game.camera.position.lerp(world.bodies[30].position, 0.01);
